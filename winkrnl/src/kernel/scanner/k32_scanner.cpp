#include "k32_scanner.hpp"

#include <vuln/drivers/basic_vuln_driver.hpp>

#include <vector>

K32PatternScanner::K32PatternScanner(std::shared_ptr<BasicVulnDriver> driver)
    : driver(std::move(driver))
{
}

uintptr_t K32PatternScanner::FindPatternAddr(uintptr_t moduleBase, size_t moduleSize, const char* pattern, const char* mask) const
{
